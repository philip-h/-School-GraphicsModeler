...
$(PROGRAM_NAME): main.o node.o nodeGroup.o nodeModel.o nodeTransform.o sceneGraph.o BoundedBox.o ray.o $(MATH_LIB)/PVector.o $(MATH_LIB)/PPoint.o
	$(CC) -o $@ $^ $(CFLAGS) $(LDFLAGS)

clean:
	$(RM) *.o $(PROGRAM_NAME)$(EXEEXT) $(MATH_LIB)/*.o